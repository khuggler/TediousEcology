...
x<-CollarHistory(capdat = capdat, df = '%m/%d/%Y')
x$Ser1Start<-as.Date(x$Ser1Start,df)
x$Ser1End<-as.Date(x$Ser1End,df)
x$Ser2Start<-as.Date(x$Ser2Start,df)
x$Ser2End<-as.Date(x$Ser2End,df)
x$Ser3Start<-as.Date(x$Ser3Start,df)
x$Ser3End<-as.Date(x$Ser3End,df)
x$Ser4Start<-as.Date(x$Ser4Start,df)
x$Ser4End<-as.Date(x$Ser4End,df)
